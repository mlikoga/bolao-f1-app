export class Bet {
  ...
  constructor(user: string, race: string, pole?: string, qualifying2?: string, qualifying3?: string,
  ...
  var { user, race,
    ...
    return new Bet(user, race, pole, qualifying2, qualifying3, positions, forgotten);
  }
