export class BetPoints {
  ...
  static from({ pole, qualifying2, qualifying3, positions, extra, user, race}): BetPoints {
    return new BetPoints(user, race, pole, qualifying2, qualifying3, positions, extra);
  }
